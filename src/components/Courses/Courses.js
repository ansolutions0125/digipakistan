...
const courses = [
  // IT Fundamentals
  {
    ...
    courseCategory: "fast_track_technical_course",
    courseEnrollments: "",
...
,
  ...
  // ASPNEt
  {
    ...
    courseTitle: "ASP.Net MVC Development",
    batchDuration: "3 Months",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
    courseCategory: "fast_track_technical",
  ...
  // IOS
  {
    id: "ios",
    thumbnail: "",
    courseTitle: "iOS App Creation using SwiftUI",
    courseLogo: "/ios.png",
    batchDuration: "3 Months",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
  ...
  // CCNA
  {
    ...
    thumbnail: "",
    courseLogo: "/ccna.png",
    courseTitle: "Cisco CCNA (Routing & Switching)",
    batchDuration: "3 Months",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
    courseCategory: "fast_track_technical",
  ...
  // CERTIFIED HACKING FORENSIC INVESTIGATOR
  {
    id: "chfi",
    thumbnail: "",
    courseTitle: "Certified Hacking Forensic Investigator (CHFI)",
    batchDuration: "3 Months",
    courseLogo:"/chfi.png",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
    ...
    courseInstructor: "Hassan Raza",
    courseLongDescription:
      "Learn to become a Certified Hacking Forensic Investigator (CHFI) with this comprehensive course. Dive into computer forensics, evidence collection, network forensics, malware analysis, email crime investigation, and report writing. Gain hands-on experience with practical labs and real-world forensic techniques.",
    courseShortDescription:
    ...
    seoDescription: "Certified Hacking Forensic Investigator (CHFI) Course",
    seoKeywords: [
      "CHFI Certification",
  ...
  //AWS PRACTITIONER
  {
    id: "aws_practitioner",
    thumbnail: "",
    courseTitle: "AWS Practitioner Certification",
    batchDuration: "3 Months",
  ...
  //AWS SOLUTIONS ARCHITECT
  {
    ...
    thumbnail: "",
    courseTitle: "AWS Solutions Architect Certification",
    batchDuration: "3 Months",
    courseLogo:"/aws.png",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
  ...
  //AWS SYSOPS
  {
    ...
    thumbnail: "",
    courseTitle: "AWS SysOps Administrator Certification",
    batchDuration: "3 Months",
  ...
  // Azure Fundamentals
  {
    ...
    thumbnail: "",
    courseTitle: "Microsoft Azure Fundamentals Certification (AZ-900)",
    batchDuration: "3 Months",
  ...
  // MICROSOFT CLOUD ADMINISTRATOR
  {
    ...
    thumbnail: "",
    courseTitle: "Microsoft Cloud Administrator (AZ-104 Certification)",
    batchDuration: "3 Months",
  ...
  // GOOGLE CLOUD ENGINEER
  {
    ...
    courseTitle:
      "Google Cloud Engineer Certification (Associate Cloud Engineer)",
    batchDuration: "3 Months",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
    courseCategory: "fast_track_technical",
  ...
  // Data Science
  {
    id: "data_science",
    thumbnail: "",
    courseTitle: "Data Science Certification",
    batchDuration: "3 Months",
...

  {
    id: "quickbooks_erp",
    thumbnail: "",
    courseTitle: "QuickBooks ERP Certification",
    batchDuration: "3 Months",
  ...
  // AMAZON FBA Services
  {
    ...
    thumbnail: "",
    courseTitle: "Amazon FBA Business Certification",
    batchDuration: "3 Months",
  ...
  // Search Engine Optimization
  {
    ...
    thumbnail: "",
    courseTitle: "Search Engine Optimization (SEO) Certification",
    batchDuration: "3 Months",
    courseLogo:"/seo.png",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
...

  {
    ...
    thumbnail: "",
    courseTitle:
      "Meta Marketing - Facebook, Instagram & WhatsApp Certification",
    batchDuration: "3 Months",
    courseLogo:"/meta.png",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from metaPAKISTAN",
  ...
  // UI UX
  {
    id: "ui_ux_design",
    thumbnail: "",
    courseTitle: "UI/UX Design Certification",
    batchDuration: "3 Months",
    courseLogo:"/uiux.png",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
...

  {
    id: "video_editing",
    thumbnail: "",
    courseTitle: "Video Editing Certification",
    batchDuration: "3 Months",
  ...
  //  Auto CAD
  {
    id: "autocad",
    thumbnail: "",
    courseTitle: "AutoCAD Certification",
    batchDuration: "3 Months",
    courseLogo:"/acad.png",
    certificate:
      "On successful completion of the course participants will be awarded a participation certificate from DigiPAKISTAN",
  ...
  // Enterprenureship
  {
    ...
    thumbnail: "",
    courseTitle: "Entrepreneurship Certification",
    batchDuration: "3 Months",
