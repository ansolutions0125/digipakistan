  ...
  return (
    <div className="w-full">
      ...
      <div className="lg:p-10 p-3">
          <h1 className="py-3 font-semibold text-2xl">To Participate in DigiPakistan National Skills Development Initiative, students have to adopt the following process.</h1>
          <h1 className="font-bold">Note: <span className="font-normal">Minimum of 10 years education is a prerequisite to apply for any DigiPAKISTAN training program. Computer know-how and basic proficiency in English will be desirable.</span></h1>
