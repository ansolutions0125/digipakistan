...
const PersonalInfo = () => {
  ...
  //set form Data by getting previous form data as it is
    setFormData((prev) => {
      ...
      } else if (name === "thirdCourse") {
        updatedSelectedCourses[2] =
          coursesData.find((course) => course.courseCategory === value) || {};
      }
  
      updatedFormData.selectedCourses = updatedSelectedCourses;
  ...
  const handleCourseSelect = (e, index) => {
    ...
    setFormData((prev) => {
      ...
      // Find the course object based on the selected title
      const selectedCourseObject =
        coursesData.find((course) => course.courseTitle === value) || {};
  
      // Safely update the selectedCourses array
      updatedSelectedCourses[index] = selectedCourseObject;
                ...
                <div className="mt-7">
                  ...
                  <div className="relative mt-6 mb-6">
                    ...
                    >
                      ...
                      <option
                        className="p-3 rounded"
                        value="associate_certificate_program"
                      >
                  ...
                  {formData.firstCourse && (
                    <div className="relative mt-6 mb-6">
                      <select
                        ...
                        value={formData.selectedCourses[0]?.courseTitle || ""}
                  ...
                  {formData.secondCourse && (
                    <div className="relative mt-6 mb-6">
                      <select
                        ...
                        value={formData.selectedCourses[1].courseTitle || null}
                  ...
                  {formData.thirdCourse && (
                    <div className="relative mt-6 mb-6">
                      <select
                        ...
                        value={formData.selectedCourses[2].courseTitle || null}
