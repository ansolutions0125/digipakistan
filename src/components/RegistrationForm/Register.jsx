...
if(userData){
  ...
  return (
    <div className="apply_bg bg-gray-100 min-h-[70vh]">
      <div className="flex items-center justify-center p-3 lg:p-5">
        <div className="w-full min-h-[60vh] rounded-xl bg-white flex flex-col border shadow-2xl text-center p-5 lg:w-[30%]">
          ...
          <div className="flex flex-col lg:mx-auto text-center p-5 lg:w-[100%]">
