...
const AddCourse = () => {
  ...
  const [uploadProgressExamCertificateLogo, setUploadProgressExamCertificateLogo] = useState(0);
  ...
  const handleSubmit = async () => {
    if (validateStep()) {
      ...
      await setDoc(doc(firestore, "site_videos", formData.video_vimeoId), {
        ...formData,
        created_at: serverTimestamp(),
        updated_at: serverTimestamp(),
      });
      showToast(`Video has been added successfuly.`, "info", 2000);
