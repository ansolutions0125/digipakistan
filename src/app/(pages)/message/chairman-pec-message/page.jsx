...
import ChairmanPECMessage from "@/components/Messages/ChairmanPECMessage";
...
const DirectorGeneralMessages = async () => {
...
//   const certifications = await getAllCertificationCategoryes();
  return (
    <>
      ...
      {/* Page Info */}
      <PageInfo PageName="Chairman PEC Message"/>
      {/* All Courses */}
      <main className="p-6">
...
export default DirectorGeneralMessages;
