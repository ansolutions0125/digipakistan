...
import ProvincialMinisterMessage from "@/components/Messages/ProvincialMinisterMessage";
import DirectorGeneralMessage from "@/components/Messages/DirectorGeneralMessage";
import ChairmanHECMessage from "@/components/Messages/ChairmanHECMessage";
 
export function generateMetadata()
{
  return {
    title: {
      default: "Provincial Minister Message",
...
const ChairmanHECMessages= async () => {
//   const data = await gsetAllCourses();
//   const certifications = await getAllCertificationCategoryes();
  return (
    <>
      ...
      {/* Page Info */}
      <PageInfo PageName="Chairman HEC Message"/>
      {/* All Courses */}
      <main className="p-6">
...
export default ChairmanHECMessages;
