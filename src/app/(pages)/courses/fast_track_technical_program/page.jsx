...
//   const certifications = await getAllCertificationCategoryes();
  return (
    <>
      ...
      {/* Page Info */}
      <PageInfo PageName="Fast Track Technical Program (3 Months)" pageDescription="A continuously evolving stack of Information Technology Programs consoling the latest technologies are available at DigiPAKISTAN and all you have to do is to enrol yourself in your desired course." />
      {/* All Courses */}
